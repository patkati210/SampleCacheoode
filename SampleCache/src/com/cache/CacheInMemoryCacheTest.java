...
public class CacheInMemoryCacheTest {
 
    public static void main(String[] args) throws InterruptedException {
 
    	CacheInMemoryCacheTest  Cache = new CacheInMemoryCacheTest();
    ...
    private void  TestAddRemoveObjects() {
        ...
        // maxItems = 6
        CacheInMemoryCache<String, String> cache = new CacheInMemoryCache<String, String>(200, 500, 6);
    ...
    private void  TestExpiredCacheObjects() throws InterruptedException {
        ...
        // maxItems = 10
        CacheInMemoryCache<String, String> cache = new CacheInMemoryCache<String, String>(1, 1, 10);
    ...
    private void  TestObjectsCleanupTime() throws InterruptedException {
        ...
        CacheInMemoryCache<String, String> cache = new CacheInMemoryCache<String, String>(100, 100, 500000);
